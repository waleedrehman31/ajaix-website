            ...
            "
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
						<div className="relative">
							...
							<div className="absolute -bottom-6 -right-6 bg-white rounded-xl shadow-lg p-6 max-w-[210px]">
					...
					<div>
						...
						<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
							{values.map((value, index) => (
								<div
									className="flex flex-col gap-6 rounded-xl text-center border-0 bg-white shadow-md hover:shadow-lg transition-shadow"
									key={index}
								>
									<div className="p-6">
