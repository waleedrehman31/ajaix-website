...
const ServicesCard = ({ service }) => {
	return (
		<article className="inline-flex flex-col gap-6 rounded-xl group shadow-md mb-3 hover:shadow-xl transition-all duration-300 border-0 bg-white/30 backdrop-blur-3xl">
